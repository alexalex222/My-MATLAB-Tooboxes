function [model,pie_chart,label_given,restart,ssii,option1,option2,option3,option4]=stream_AP_load(data,B_n,label_all,nb_data_to_process,nb_f,varargin);
%%%
