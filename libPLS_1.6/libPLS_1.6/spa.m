function F=spa(X,y,A,K,Q,N,ratio,method,weight,PROCESS)
...
for i=1:N
    ...
    CV=plsldacv(Xcal,ycal,A,K,method,weight,0);
    nLV(i)=CV.optLV;
    %+++ Build a PLS-LDA model
    LDA=plslda(Xcal,ycal,CV.optLV,method,weight);
