function CV=plsldacv(X,y,A,K,method,weight,OPT,order)
...
%       weight: 0 (default) or 1, whether to weight samples
%          OPT: =1 Print process.
%               =0 No print.
...
for group=1:K
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%% SIM algorithm  %%%%%%%%%%%%%%   
    [B,wstar,T,P]=pls_nipals(Xcal,ycals,A);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    for j=1:A
        %%%+++ train model.        
        TT=T(:,1:j); 
        C=ldapinv(TT,ycal,weight);
