function [xy,L,l,th] = draw_ellipse(m,A,col,lw)
...
%% m = vector containing x and y coords of center (mean of the distribution)
...
hold on;
plot(cxy(1) + xy(1,:), cxy(2) + xy(2,:), col, 'LineWidth', lw);  %% Draw ellipse
