...
mxReadVectorDef(mxReadUnsignedVector,unsigned int,"%d ");
...
/*mxReadCellVectorDef(mxReadUnsignedCellVector,unsigned int);*/
...
mxWriteCellVectorDef(mxWriteUnsignedCellVector, unsigned int);
